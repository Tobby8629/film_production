...
const Hero = () => {
  ...
  return (
    <header ref={heroRef} className="main_wrapper max-md:!p-2.5 max-md:h-[80vh] h-[100vh] xl:h-[90vh] opacity-0 overflow-hidden md:pt-10 ">
            ...
            <SwiperSlide key={index} className="first_service">
              ...
              <div className="header_text">
                ...
                <p className="leading-8">
                  {resize.screen === "mobile"  ? `${item.text.slice(0, 150)}...` : item.text}
                </p>
                <Link
